...
os.chdir('C:/Users/pc/workspace/django/djangostudy/project')

def crawler(company_code, maxpage):
    page = 1
    df = pd.DataFrame(index=range(0,1), columns=['날짜', '언론사', '기사제목', '링크'])
    while page <= int(maxpage):
        ...
        print("다운 받고 있습니다------", page)

        page += 1
    df.to_csv('news.csv', mode='w', encoding='utf-8-sig')
    # 종목 리스트 파일 열기
